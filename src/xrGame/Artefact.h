...
public:
    ...
    float GetHydrationPower() const { return m_fHydrationRestoreSpeed; }
    ...
    void SetHydrationPower(const float value) { m_fHydrationRestoreSpeed = value; }
...
public:
    ...
    float m_fHydrationRestoreSpeed;
